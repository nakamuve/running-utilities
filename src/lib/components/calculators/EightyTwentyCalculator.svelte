<script>
	import {
		eightyTwentyCalculate,
		eightyTwentyDistanceOptions,
		timeToSeconds
...
<div class="px-4 py-6">
	<h2 class="mb-6 text-2xl font-bold">80/20 Endurance Zone Calculator</h2>

	<div class="mb-6 text-sm text-gray-600">
		<p>
			Enter your race distance and time to calculate training zones based on Matt Fitzgerald's 80/20
			Running method.
		</p>
	</div>
		...
		<div class="space-y-6">
					...
					<div class="grid grid-cols-1 gap-4 md:grid-cols-3">
						<div>
							...
							<p class="font-semibold">
								{eightyTwentyDistanceOptions.find(
									(option) => option.value === calculatedZones.race_distance
								)?.label || calculatedZones.race_distance}
							</p>
						</div>
						<div>
			...
			<div class="card bg-base-100 shadow-xl">
				<div class="card-body">
					...
					<p class="mb-4 text-sm opacity-70">Based on Matt Fitzgerald's 80/20 Running method</p>
			...
			<div class="card bg-base-100 shadow-xl">
				<div class="card-body">
					...
					<p class="mb-2 text-sm opacity-70">Percentages are based on Maximum Heart Rate</p>
					<p class="mb-4 text-sm opacity-70">
						To calculate actual heart rates, multiply your max heart rate by these percentages
					</p>
