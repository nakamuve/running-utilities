...
<div class="px-4 py-6">
	<h2 class="mb-6 text-2xl font-bold">KM-Effort Calculator</h2>

	<div class="mb-6 text-sm text-gray-600">
		<p>
			The KM-Effort calculator helps you understand the real effort of your runs by accounting for
			elevation gain. For every 100m of elevation gain, it adds 1km to the effective distance.
		</p>
	</div>
	...
	<form on:submit|preventDefault={calculateEffort} class="mb-8">
		<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
			...
			<div class="form-control md:col-span-2">
				<button
					type="submit"
					class="btn btn-primary w-full md:ml-auto md:w-auto"
					disabled={loading}
				>
					{#if loading}
	...
	{#if effortResults}
		<div class="bg-base-200 rounded-lg p-6">
			<h3 class="mb-4 text-lg font-semibold">KM-Effort Results</h3>

			<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
				<div>
					<h4 class="mb-2 font-semibold">Input Details</h4>
				...
				<div>
					<h4 class="mb-2 font-semibold">Effort Calculations</h4>
					<ul class="list-disc space-y-1 pl-5">
						<li>
							<span class="font-medium">KM-Effort: {effortResults.km_effort} km</span>
							<span class="text-sm text-gray-600"
								>(+{effortResults.km_effort_percent}% increase)</span
							>
						</li>
			...
			{#if effortResults.pace_per_km}
				<div class="mt-6">
					<h4 class="mb-2 font-semibold">Pace Calculations</h4>
			...
			<div class="mt-4 text-sm text-gray-600">
				<p>
					Note: KM-Effort calculations help compare runs with different elevation profiles. For
					example, a flat 10km run requires similar effort to an 8km run with 200m of elevation
					gain.
				</p>
			</div>
		</div>
